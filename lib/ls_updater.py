...
class LoadSensingFirmwareUpdater:
            ...
            while self.receive:
                if self.ser.in_waiting > 0:
                    ...
                    if "STM32 SBSFU Bootloader" in line:
                        ...
                        print(f"\r\nNode on {YELLOW}{self.port}{RESET}: Bootloader" + GREEN + " FOUND!" + RESET)
    ...
    def download_nonsecure_app(self, file_name: str):
        ...
        try:
            ...
            if not file_name:
                print(f"No filename given, searching for {BLUE}LoadSensingG_App{RESET} on machine... ", end="")
...
def main():
    ...
    parser.add_argument("--file", type=str, default="", help="Application binaries to flash to node")
