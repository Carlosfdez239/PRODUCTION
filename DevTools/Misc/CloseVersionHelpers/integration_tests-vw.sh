...
SCR_SENDDATA="./test_send20VWData.sh"
...
echo 3
IT_PrintTimestamp "SEND GET 20 VW DATA "
$SCR_SENDDATA $TTY
...
echo 7
IT_PrintTimestamp "RECOVER VW DATA"
$SCR_SEND "\x03\x41\x00\x00\x00\x00\xFF\xFF\xFF\xFF" $TTY
sleep 10
