...
def enter_ser_bridge_mode(ser, baudrate):
    if baudrate == 38400:
        # Send the packet to enter bridge mode
        config_base = b"\x10\x02\x12\x01\x00\x00\x96\x00\x08\x01\x00\x64\x2B\x2B\x2B\x03\x00\x78\x00\x78\x10\x03"
    elif baudrate == 9600:
        # Send the packet to enter bridge mode
        config_base = b"\x10\x02\x12\x01\x00\x00\x25\x80\x08\x01\x00\x64\x2B\x2B\x2B\x03\x00\x78\x00\x78\x10\x03"
    elif baudrate == 115200:
        # Send the packet to enter bridge mode
        config_base = b"\x10\x02\x12\x01\x00\x01\xC2\x00\x08\x01\x00\x64\x2B\x2B\x2B\x03\x00\x78\x00\x78\x10\x03"
