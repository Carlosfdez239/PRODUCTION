...
flashsectnbr=0xff
oem2_key_word0=<Get the key from 1Password>
oem2_key_word1=<Get the key from 1Password>
...
$stm32programmercli $connect_no_reset -unlockRDP2 ${oem2_key_word0} ${oem2_key_word1}
