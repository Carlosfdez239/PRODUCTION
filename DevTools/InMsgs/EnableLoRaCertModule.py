...
class Example(wx.Frame):
    ...
    def init_ui(self):
        ...
        wx.StaticText(pnl, label="ttyUSB Number", pos=(175, vertical_pos + 6))
        w_tty_usb = wx.TextCtrl(pnl, -1, size=(90, 30), pos=(80, vertical_pos))
        ...
        w_set_config_btn = wx.Button(pnl, label="Enable Module", pos=(70, vertical_pos))
        w_set_config_btn.Bind(wx.EVT_BUTTON, enable_module)

        w_set_config_btn = wx.Button(pnl, label="Disable Module", pos=(190, vertical_pos))
        w_set_config_btn.Bind(wx.EVT_BUTTON, disable_module)

        vertical_pos = vertical_pos + vertical_pos_increment
        vertical_pos = vertical_pos + vertical_pos_increment
        self.SetSize((350, vertical_pos))
